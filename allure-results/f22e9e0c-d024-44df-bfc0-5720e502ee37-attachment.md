...
- Name: performance\performanceLite.spec.ts >> Performance Engineering @api >> PERF-02 | 20 concurrent GET accounts requests complete without errors @api
- Location: tests\performance\performanceLite.spec.ts:33:7

# Error details

```
Error: 20/20 concurrent requests failed. First error: apiRequestContext.get: unable to get local issuer certificate
Call log:
